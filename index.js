    ...
    AirportInput("fromIATA", options);
    AirportInput("toIATA", options);

   // Get the input field
var input = document.getElementById("dateOfFlight");
...
function flightSearchAPI(fromFlight, toFlight, date) {
    ...
    fromFlight = fromFlight.toUpperCase().substring(0,3);
    toFlight = toFlight.toUpperCase().substring(0,3);
    console.log("from",fromFlight);
    var constructURL = "https://soarch.herokuapp.com/find/" + fromFlight + "&" + toFlight + "&1&1&" + date;
    //var constructURL = var constructURL = "http://localhost:8090/find/" + fromFlight + "&" + toFlight + "&1&1&" + date;
